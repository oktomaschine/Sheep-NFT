...
contract Sheep is ERC721A, Ownable {
    ...
    uint256 public constant PAID_SUPPLY = 100;

    uint256 private _flag;
    string private _defTokenURI = "https://ipfs.io/ipfs/bafkreihoahbr36s6fv4abkihjcdnn7imkuyd3xm6hqlmi4fpo5zaogj7vm";
    ...
    constructor() ERC721A("Whimsical Euphoria: A White Inflatable Sheep", "ALL") {
    }
